...
export default function Custom404() {
  return (
    <>
      <Head>
        <title>Page Not Found | Sikhadenge</title>
      ...
      <main className="relative min-h-screen overflow-hidden bg-[#0B1220] px-4 pb-20 pt-32 text-white sm:px-6">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="rounded-3xl border border-white/10 bg-[#111827]/75 p-7 shadow-[0_24px_90px_rgba(0,0,0,0.34)] backdrop-blur sm:p-10">
            ...
            <h1 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">This Sikhadenge page is not available</h1>
            <p className="mt-5 max-w-3xl text-base leading-8 text-[#B0B7C3]">
              Check the address or use one of the public navigation routes below. This response remains a genuine 404 rather than returning a generic 200 page.
            </p>
