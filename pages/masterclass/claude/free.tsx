...
const audience = [
  ...
  ["Students & job seekers", "Build a practical AI workflow you can use in projects and career preparation."],
    ...
    <>
      ...
      <main className={styles.page}>
        ...
        <section className={styles.final}>
          <div className={`${styles.container} ${styles.finalBox}`}><div><span className={styles.eyebrow}>NEXT LIVE BATCH</span><h2>Your first Claude workflow starts with one live session.</h2><p>Reserve your free seat and continue to the existing secure SikhaDenge registration page.</p></div><Cta>Yes, Reserve My Free Seat</Cta></div>
        </section>
      </main>
    </>
  );
