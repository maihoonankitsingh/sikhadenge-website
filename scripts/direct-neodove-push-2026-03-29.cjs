...
(async () => {
  const start = new Date('2026-03-28T18:30:00.000Z'); // 2026-03-29 00:00:00 IST
  const end   = new Date('2026-03-29T18:29:59.999Z'); // 2026-03-29 23:59:59 IST
  ...
  for (const row of rows) {
    ...
    leads.push({
      ...
      detail1: 'source=backfill_masterclasszoomjoin_2026_03_29',
