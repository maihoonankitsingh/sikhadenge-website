...
const SLUG = "/blog/after-effects-beginners-guide";
const TITLE = "After Effects basics for beginners: keyframes, text animation, clean output";
const DESC = "After Effects fundamentals explained: keyframes, easing, text animation, and how to make motion look clean.";
