...
const SLUG = "/blog/premiere-pro-reels-editing-workflow";
const TITLE = "Premiere Pro workflow for Reels: cuts, captions, pacing, export";
const DESC = "A practical Premiere Pro workflow for Instagram Reels: timeline setup, pacing, captions, audio cleanup, and export.";
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/ai-tools/ai-video-editing-tools"
