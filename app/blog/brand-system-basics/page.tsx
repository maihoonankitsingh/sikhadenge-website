...
const SLUG = "/blog/brand-system-basics";
const TITLE = "Brand system basics: logo, colors, type, grid, and usage rules";
const DESC = "Brand system fundamentals: what to define, how to keep consistency, and what to include in brand guidelines.";
