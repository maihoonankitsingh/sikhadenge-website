...
const SLUG = "/blog/genai-workflow-for-creators";
const TITLE = "GenAI workflow for creators: brief → ideas → draft → refine";
const DESC = "A practical GenAI workflow to improve creative output: write better briefs, generate options, refine, and finalize.";
