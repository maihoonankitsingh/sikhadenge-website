...
const SLUG = "/blog/portfolio-projects-for-beginners";
const TITLE = "Portfolio projects for beginners: 7 ideas that show real skill";
const DESC = "Seven beginner-friendly portfolio project ideas that clearly show your design or editing skills with output.";
