...
const SLUG = "/blog/typography-hierarchy-checklist";
const TITLE = "Typography hierarchy checklist: make designs readable and premium";
const DESC = "A typography checklist for better hierarchy: size, weight, spacing, alignment, and consistency.";
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            >
              ChatGPT for typography feedback
            </Link>
            <Link
              href="/contact-us"
