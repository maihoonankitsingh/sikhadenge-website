...
const SLUG = "/blog/color-theory-for-creators";
const TITLE = "Color theory for creators: contrast, harmony, and palette selection";
const DESC = "A practical color theory guide: contrast, harmony, and choosing palettes that work for real designs.";
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/ai-tools/gemini-for-creators"
