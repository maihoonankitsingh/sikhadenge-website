...
export const metadata: Metadata = {
  title: "Graphic Design Course (Live Online) | Sikhadenge",
  description: "Learn Graphic Design with live online classes: Photoshop, Illustrator, typography, branding, and portfolio projects.",
  alternates: { canonical: "/courses/graphic-design" },
  openGraph: {
    type: "website",
    ...
    <main className="min-h-screen bg-[#0B1220] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <h1 className="mt-2 text-2xl md:text-4xl font-semibold leading-tight">Graphic Design</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context": "https://schema.org", "@type": "Course", "name": "Graphic Design Course", "description": "Live online Graphic Design course covering Photoshop, Illustrator, composition, typography, branding, and portfolio projects.", "url": "https://sikhadenge.in/courses/graphic-design", "provider": {"@type": "Organization", "name": "Sikhadenge", "url": "https://sikhadenge.in"}, "educationalCredentialAwarded": "Certificate of Completion", "inLanguage": "en", "about": ["Graphic Design", "Adobe Photoshop", "Adobe Illustrator", "Branding", "Typography"], "hasCourseInstance": {"@type": "CourseInstance", "courseMode": "online", "location": "Online"}}`,
        }}
      />
      <script
        type="application/ld+json"
