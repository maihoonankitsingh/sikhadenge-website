...
export const metadata: Metadata = {
  title: "AI Mastery Course for Creators and Digital Work | Sikhadenge",
  description: "Practical AI workflows for creators, students, freelancers, and working professionals. Learn prompts, ideation, creative briefs, design support, and production assistance with Sikhadenge.",
  alternates: { canonical: "/courses/ai-mastery" },
  openGraph: {
    type: "website",
    url: "https://sikhadenge.in/courses/ai-mastery",
    siteName: "Sikhadenge",
    title: "AI Mastery Course for Creators and Digital Work | Sikhadenge",
    description: "Practical AI workflows for creators, students, freelancers, and working professionals. Learn prompts, ideation, creative briefs, design support, and production assistance with Sikhadenge.",
  },
    ...
    <main className="min-h-screen bg-[#0B1220] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <h1 className="mt-2 text-2xl md:text-4xl font-semibold leading-tight">Ai Mastery</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context": "https://schema.org", "@type": "Course", "name": "AI Mastery Course for Creators and Digital Work", "description": "Practical AI workflows for creators, students, freelancers, and working professionals across prompts, ideation, creative briefs, design support, and production assistance.", "url": "https://sikhadenge.in/courses/ai-mastery", "provider": {"@type": "Organization", "name": "Sikhadenge", "url": "https://sikhadenge.in"}, "educationalCredentialAwarded": "Certificate of Completion", "inLanguage": "en", "about": ["GenAI", "Automate Work with AI", "Prompts", "Creative Briefs"], "hasCourseInstance": {"@type": "CourseInstance", "courseMode": "online", "location": "Online"}}`,
        }}
      />
      <script
        type="application/ld+json"
