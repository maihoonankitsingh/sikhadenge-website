...
export const metadata: Metadata = {
  title: "AI + Typography & Layout | Sikhadenge",
  description: "Typography and layout fundamentals with practical hierarchy rules and AI-assisted iteration for better composition.",
  alternates: { canonical: "/courses/ai-typography-layout" },
  openGraph: {
    type: "website",
    url: "https://sikhadenge.in/courses/ai-typography-layout",
    siteName: "Sikhadenge",
    title: "AI + Typography & Layout | Sikhadenge",
    description: "Typography and layout fundamentals with practical hierarchy rules and AI-assisted iteration for better composition.",
  },
    ...
    <main className="min-h-screen bg-[#0B1220] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <h1 className="mt-2 text-2xl md:text-4xl font-semibold leading-tight">Ai Typography Layout</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context": "https://schema.org", "@type": "Course", "name": "AI + Typography & Layout", "description": "Typography and layout fundamentals with practical composition rules and AI-assisted iteration for better hierarchy.", "url": "https://sikhadenge.in/courses/ai-typography-layout", "provider": {"@type": "Organization", "name": "Sikhadenge", "url": "https://sikhadenge.in"}, "educationalCredentialAwarded": "Certificate of Completion", "inLanguage": "en", "about": ["Typography", "Layout", "Hierarchy", "AI Assistance"], "hasCourseInstance": {"@type": "CourseInstance", "courseMode": "online", "location": "Online"}}`,
        }}
      />
      <script
        type="application/ld+json"
