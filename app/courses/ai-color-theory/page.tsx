...
export const metadata: Metadata = {
  title: "AI + Color Theory | Sikhadenge",
  description: "Color theory for creators with practical exercises and AI-assisted exploration of palettes and mood boards.",
  alternates: { canonical: "/courses/ai-color-theory" },
  openGraph: {
    type: "website",
    url: "https://sikhadenge.in/courses/ai-color-theory",
    siteName: "Sikhadenge",
    title: "AI + Color Theory | Sikhadenge",
    description: "Color theory for creators with practical exercises and AI-assisted exploration of palettes and mood boards.",
  },
    ...
    <main className="min-h-screen bg-[#0B1220] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="border border-white/10 rounded-3xl bg-[#111827] p-6 md:p-10">
          ...
          <h1 className="mt-2 text-2xl md:text-4xl font-semibold leading-tight">Ai Color Theory</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context": "https://schema.org", "@type": "Course", "name": "AI + Color Theory", "description": "Color theory for design work with practical exercises and AI-assisted exploration of palettes and mood boards.", "url": "https://sikhadenge.in/courses/ai-color-theory", "provider": {"@type": "Organization", "name": "Sikhadenge", "url": "https://sikhadenge.in"}, "educationalCredentialAwarded": "Certificate of Completion", "inLanguage": "en", "about": ["Color Theory", "Design Fundamentals", "AI Assistance"], "hasCourseInstance": {"@type": "CourseInstance", "courseMode": "online", "location": "Online"}}`,
        }}
      />
      <script
        type="application/ld+json"
