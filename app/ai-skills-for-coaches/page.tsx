...
export const metadata: Metadata = {
  title: "Best AI Skills for Coaches | Sikhadenge",
  description:
    "Explore the best AI skills for coaches who want stronger client support, better session systems, faster content execution, and more scalable coaching delivery.",
};

const heroCards = [
  {
    eyebrow: "Best Focus",
    title: "Coaches should build AI skills across modern coaching and client delivery systems.",
    text:
  ...
  {
    eyebrow: "Main Goal",
    title: "The goal is to improve client experience without increasing delivery chaos.",
    text:
  ...
  },
  {
    ...
    title: "AI improves clarity, speed, and delivery confidence for coaches.",
    text:
...
const whyCards = [
  {
    title: "Coaching needs broader execution capability",
    text:
  ...
  {
    title: "AI improves speed and coaching consistency",
    text:
  ...
  {
    title: "Better systems create stronger coaching leverage",
    text:
...
const skillCards = [
  ...
  {
    title: "Session planning and support",
    text:
  ...
  {
    title: "Offers and sales conversation support",
    text:
  ...
  {
    title: "Worksheets and learning asset support",
    text:
...
const resultCards = [
  ...
  {
    title: "Scalable coaching systems",
    text:
...
const relatedLinks = [
  ...
  { href: "/ai-skills-for-course-creators", label: "AI Skills for Course Creators" },
  { href: "/ai-skills-for-consultants", label: "AI Skills for Consultants" },
...
const faqs = [
  {
    q: "Which AI skills are best for coaches right now?",
    a:
  ...
  {
    q: "Why do coaches need broader AI capability?",
    a:
  ...
  {
    q: "Can AI skills help coaches serve clients better?",
    a:
  ...
  {
    q: "Do coaches need coding to use AI effectively?",
    a:
  ...
  {
    q: "What is the biggest mistake coaches make while learning AI?",
    a:
  ...
  {
    q: "Can these skills help build long-term coaching systems?",
    a:
...
export default function AiSkillsForCoachesPage() {
  return (
    <main className="min-h-screen bg-[#F3F6FB] text-[#0F172A]">
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-14 sm:px-6 lg:px-8">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 max-w-3xl text-[15px] leading-7 text-[#5B6475] sm:text-[16px]">
            Coaches now need more than isolated calls or generic content. The best AI skills are
            the ones that improve real coaching execution across communication, session planning,
            worksheets, offers, follow-ups, and workflow systems. These capabilities help people
            build more efficient, more reliable, and more scalable coaching delivery.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[15px] leading-7 text-[#677184]">
              ...
              consistency, client clarity, and long-term coaching leverage.
            </p>
          </div>
      ...
      <section className="border-t border-[#E7EDF6] bg-[#F3F6FB]">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[15px] leading-7 text-[#677184]">
              The best coach AI skill stack is practical, client-oriented, and directly connected
              to real coaching execution across modern delivery systems.
            </p>
          </div>
      ...
      <section className="border-t border-[#E7EDF6] bg-[#F3F6FB]">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          <SectionLabel>Coaching outcome</SectionLabel>
          <div className="max-w-3xl">
            <h2 className="text-3xl font-extrabold tracking-[-0.03em] text-[#0F172A] sm:text-4xl">
            ...
            <p className="mt-4 text-[15px] leading-7 text-[#677184]">
              ...
              structured, more efficient, and more scalable in coaching delivery.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="rounded-[28px] border border-[#E3EAF5] bg-white p-8 shadow-[0_20px_55px_rgba(15,23,42,0.06)] sm:p-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-[15px] leading-7 text-[#677184]">
                These pages help coaches understand how AI skills connect with consulting,
                course creation, broader learning paths, and the AI Expert model.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[15px] leading-7 text-[#677184]">
              ...
              skills to build for coaching work.
            </p>
          </div>
